...
class TestCredentials:
    def teardown_method(self):
        import bot_ruleta.credentials as cred
    ...
    def test_set_runtime_config_stores_values(self):
        from bot_ruleta.credentials import set_runtime_config, _runtime_overrides
    ...
    def test_load_credentials_with_runtime_overrides(self):
        from bot_ruleta.credentials import set_runtime_config, load_credentials
    ...
    def test_cache_returns_cached_value(self):
        from bot_ruleta.credentials import _cache_get, _cache_set, _credentials_cache
...
class TestThresholds:
    ...
    def test_threshold_runtime_override(self):
        from bot_ruleta.credentials import _runtime_overrides
