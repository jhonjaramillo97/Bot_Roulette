...
class TestBacktestSync:
    ...
    def setup_db(self, monkeypatch):
        ...
        import backend.backtesting.backtest as bt_module
    ...
    def test_sync_empty_table_no_errors(self):
        from backend.backtesting.backtest import _ZoneBacktestSync
    ...
    def test_color_sync_chain_break(self):
        from backend.backtesting.backtest import _ColorBacktestSync
    ...
    def test_number_sync_no_errors(self):
        from backend.backtesting.backtest import _NumberBacktestSync
        for i in range(10):
